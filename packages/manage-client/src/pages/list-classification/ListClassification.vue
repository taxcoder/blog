...
import { provide, reactive, ref, watch, onMounted, onActivated } from 'vue';
...
import { messageError, messageSuccess } from '@/config/message';
...
onActivated(() => {
  router.push(`/list/classifications?key=${formState.select}&value=${formState.value}`);
});
