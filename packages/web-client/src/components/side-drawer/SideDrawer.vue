  ...
  >
    ...
    <div class="drawer-user-info h-full w-full relative z-9999 pt-[100px] px-[15px] pb-0">
      <div class="flex flex-col items-center">
        ...
        <p class="text-center text-[0.75rem] px-[30px] py-0 leading-[20px] text-[#606266] mb-[10px]">
          {{ getWebInfo.motto }}
        </p>
      </div>
      <div class="flex flex-col items-start mt-[5px]">
        <p v-for="item in info" key="item.id" class="text-[#606266] py-[7px] text-[0.8rem] flex items-center h-[15px]">
