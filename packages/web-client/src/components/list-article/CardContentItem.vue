...
<template>
  ...
  >
    ...
    <div class="h-[30px] flex text-[#818181] md:mt-[2px] mt-0 items-center flex-1">
      ...
      >
        <n-icon class="mr-[2px] relative top-[-1px]" size="17">
          <UpdateTwotone />
        </n-icon>
      ...
      <div class="pl-[8px] h-[50%] inline-flex items-center">
        <n-icon class="mr-[2px] relative top-[-1px]" size="14">
          <PenNib />
        </n-icon>
...
import PenNib from '@/components/icon-svg/PenNib.vue';
import FolderFilled from '@/components/icon-svg/FolderFilled.vue';
import TagSharp from '@/components/icon-svg/TagSharp.vue';
import UpdateTwotone from '@/components/icon-svg/UpdateTwotone.vue';
